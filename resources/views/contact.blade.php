...
<body>
    @include('header')
    <div
        class="grid md:grid-cols-2 gap-16 items-center relative overflow-hidden p-10 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-3xl max-w-7xl mx-auto bg-white text-[#333] my-6 font-[sans-serif] before:absolute before:right-0 before:w-[300px] before:bg-blue-400 before:h-full max-md:before:hidden">
        <div>
            <h2 class="text-3xl font-extrabold">Contactar</h2>
            <p class="text-sm text-gray-400 mt-3">¿Tiene alguna pregunta específica o desea explorar nuevas
                oportunidades? Nuestro equipo de expertos está a su disposición.</p>
            <form>
                <div class="space-y-4 mt-8">
                    ...
                    <textarea placeholder="Mensaje"
                        class="px-2 pt-3 bg-white text-black w-full text-sm border-b-2 focus:border-[#333] outline-none"></textarea>
                </div>
                <button type="button"
            ...
            <ul class="mt-4 flex justify-center lg:space-x-6 max-lg:flex-col max-lg:items-center max-lg:space-y-2 ">
                <li class="flex items-center hover:text-blue-500">
                    ...
                    <a href="javascript:void(0)" class="text-current text-sm ml-3">
                        <strong>contact@giratiempo.com</strong>
                    </a>
                </li>
        ...
        <div class="z-10 relative h-full max-md:min-h-[350px]">
            <iframe src="https://maps.google.com/maps?q=sabadell&t=&z=13&ie=UTF8&iwloc=&output=embed"
